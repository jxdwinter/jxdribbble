...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.shot_imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0.0, 0.0, 320.0, 240.0)];
        ...
        UIImageView *viewsImageView = [[UIImageView alloc] initWithFrame:CGRectMake(15.0, 245.0, 17.0, 17.0)];
        viewsImageView.image = [UIImage imageNamed:@"eye"];
        [self.contentView addSubview:viewsImageView];

        self.viewsLabel = [[UILabel alloc] initWithFrame:CGRectMake(33.0, 245.0, 65.0, 15.0)];
        ...
        UIImageView *likesImageView = [[UIImageView alloc] initWithFrame:CGRectMake(150.0, 248.0, 10.0, 10.0)];
        likesImageView.image = [UIImage imageNamed:@"heart"];
        [self.contentView addSubview:likesImageView];
        
        self.likesLabel = [[UILabel alloc] initWithFrame:CGRectMake(165.0, 245.0, 45.0, 15.0)];
        ...
        UIImageView *commentsImageView = [[UIImageView alloc] initWithFrame:CGRectMake(270.0, 248.0, 10.0, 10.0)];
        commentsImageView.image = [UIImage imageNamed:@"spech"];
        [self.contentView addSubview:commentsImageView];
        
        self.commentsLabel = [[UILabel alloc] initWithFrame:CGRectMake(285.0, 245.0, 35.0, 15.0)];
