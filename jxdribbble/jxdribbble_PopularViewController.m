...
@interface jxdribbble_PopularViewController ()<UITableViewDataSource,UITableViewDelegate,UIScrollViewDelegate>
...
- (void)viewDidLoad
{
    ...
    NSString *filename = [Path stringByAppendingPathComponent:@"popular"];
...
- (void)getData
{
    if ([CheckNetwork isExistenceNetwork])
    {
        ...
        NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"http://api.dribbble.com/shots/popular?page=%@&per_page=20",[NSString stringWithFormat:@"%lu",(unsigned long)self.pageIndex]]];
