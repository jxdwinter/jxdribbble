...
- (void)viewDidLoad
{
    ...
    NSString *filename = [Path stringByAppendingPathComponent:@"everyone"];
...
- (void)getData
{
    if ([CheckNetwork isExistenceNetwork])
    {
        ...
        NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"http://api.dribbble.com/shots/everyone?page=%@&per_page=20",[NSString stringWithFormat:@"%lu",(unsigned long)self.pageIndex]]];
